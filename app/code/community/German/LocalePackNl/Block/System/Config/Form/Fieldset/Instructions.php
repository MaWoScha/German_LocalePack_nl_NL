 ...
 */
class German_LocalePackNl_Block_System_Config_Form_Fieldset_Instructions
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        $nodepath = "modules/German_LocalePackNl";
        $helper = Mage::helper("localepacknl");
        ...
        $html .= $helper->__("On the <a href='%s'>Magento Connect page of the %s language pack</a>, you can find more information on the latest versions.",
        ...
        $html .= $helper->__("powered by")." <a href='http://www.hkweb.nl' target='_blank'>Hans Kuijpers</a> ".$helper->__("and")." <a href='http://github.com/MaWoScha/' target='_blank'>MaWoScha</a>";
        $html .= "</p>";
